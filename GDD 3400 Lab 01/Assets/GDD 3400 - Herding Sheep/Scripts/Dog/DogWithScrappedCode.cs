...
namespace GDD3400.Project01
{
    ...
    /// </summary>
    public class DogWithScrappedCode: MonoBehaviour
    {
        ...
        private void Wander()
        {
            ...
            float randYdrift = UnityEngine.Random.Range(-maxYRotationPerSecond, maxYRotationPerSecond) * Mathf.Deg2Rad * Time.fixedDeltaTime;
        ...
        private void FixedUpdate()
        {
            ...
            // Move the Dog
            rb.linearVelocity = velocity;// + wonderVelocity;
